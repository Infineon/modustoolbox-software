...
- [Tools](#tools)
- [Code Examples](https://github.com/cypresssemiconductorco/Code-Examples-for-ModusToolbox-Software) (link to separate page)
...
| Library                                                      | Details                                                      | Docs                                                         |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| [mtb-xmclib-cat3](https://github.com/cypresssemiconductorco/mtb-xmclib-cat3) | The XMC Peripheral Library (XMC Lib) consists of low-level drivers and CMSIS startup code for the XMC product family peripherals. | [API Reference](https://cypresssemiconductorco.github.io/mtb-xmclib-cat3/api_reference_manual/html/index.html) |
| [recipe-make-cat3](https://github.com/cypresssemiconductorco/recipe-make-cat3) | XMC Make build recipe provides the make files and scripts for building and programming XMC applications. | [API Reference](https://cypresssemiconductorco.github.io/recipe-make-cat3/api_reference_manual/html/index.html) |
...
(c) Cypress Semiconductor Corporation (an Infineon company), 2020-2021. This document is the property of Cypress Semiconductor Corporation and its subsidiaries ("Cypress"). 
